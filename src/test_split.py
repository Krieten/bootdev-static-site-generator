...
class TestSplit(unittest.TestCase):
    ...
    def test_extract_markdown_links(self):
        matches = extract_markdown_links(
            "This is text with a link [to yahoo](https://yahoo.com) and [to google](https://google.com)"
        )
        self.assertListEqual([("to yahoo", "https://yahoo.com"), ("to google", "https://google.com")], matches)
